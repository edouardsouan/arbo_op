...
- Je suis partie du principe qu'on pouvait choisir plusieurs variables/inconnues différentes (x, y ...)
 ...
 - J'ai supposé que si le programme évoluait, on pouvait indiquer "sqrt" pour la racine carré par exemple.
...
Je souhaite alors obliger l'utilisateur à évaluer correctement les variables.
